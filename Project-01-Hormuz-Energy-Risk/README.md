...
| Q4. Which selected importers have concentrated exporter origins? | Crude-import origin, definition-sensitivity and domestic supply-gap screens | Figures 08-12 |
| Q5. How large and persistent are Hormuz flows? | Direct EIA chokepoint data | Figures 13-15 |

All 15 code-generated charts can also be viewed in the [figure gallery](Figures/README.md).
...
| Japan / South Korea selected Hormuz-region exporter-origin share | 94.5% / 71.9% | Import-origin concentration is highest in the selected Asian sample |
...
*Figure 10. The selected Middle East group contains eight exporters; the narrower selected Hormuz-region group excludes Oman. Source: UN Comtrade, HS 2709, 2024.*

**Definition sensitivity.** The two measures are close for Japan, South Korea and the lower-share markets. China is the main exception: its selected Middle East exporter-origin share was 44.3%, versus 36.9% for the narrower selected Hormuz-region group, because Oman contributed the difference. The broad ranking of the highest-concentration markets does not change.

**Critical distinction.** Exporter origin is a screening proxy. It does not prove that a cargo physically passed through Hormuz, and some exporters have alternative routes. The domestic supply-gap measure in Figure 12 is also a proxy - not observed gross import dependence.
...
*Figure 13. Average oil flow through major maritime routes in 2024. Source: U.S. EIA.*
...
*Figure 15. Hormuz share of maritime oil trade and total oil supply. `1H25` is a first-half average.*
...
| [`04_import_exposure.py`](Code/04_import_exposure.py) | Build exporter-origin, definition-sensitivity and domestic supply-gap screens | 08-12 |
| [`05_hormuz_chokepoint.py`](Code/05_hormuz_chokepoint.py) | Analyse EIA chokepoint flows | 13-15 |

### Original exercise to report mapping

| Original desktop output | Current report output | Treatment |
|---|---|---|
| Q1: two separate energy-mix charts | Figure 01 | Combined into one bar-and-donut panel |
| Q2: four oil-geography charts | Figures 02-04 | Producer/consumer rankings combined; world-share denominators corrected |
| Q3: three market-energy charts | Figures 05-07 | All three analyses retained and redrawn |
| Q4: nine filenames, five unique charts | Figures 08-12 | Duplicate aliases removed; two origin-definition charts restored; the old combined score excluded |
| Q5: one chart defined in code but no PNG saved in the desktop folder | Figures 13-15 | Expanded into route scale, flow history and global-share evidence |

The old Q4 combined score is not reproduced because multiplying two screening proxies would imply more precision than the underlying data supports.
...
- The selected Middle East group is an eight-exporter screen; the selected Hormuz-region group excludes Oman.
...
The seven figures above form the main evidence chain. The remaining eight code outputs are preserved below so the complete Q1-Q5 analysis is visible rather than hidden or deleted.
...
### Selected Middle East exporter-origin share

![Selected Middle East exporter-origin share in 2024](Figures/09_middle_east_exporter_origin_share_2024.png)

### Crude-import exporter mix

![Exporter mix of reported crude imports in 2024](Figures/11_crude_import_exporter_mix_2024.png)

### Domestic oil supply-gap proxy

![Domestic oil supply gap proxy in 2024](Figures/12_domestic_supply_gap_proxy_2024.png)

### Hormuz flow history

![Oil flow through the Strait of Hormuz from 2020 through first-half 2025](Figures/14_hormuz_flow_2020_1H25.png)
...
`-- Figures/           # Fifteen PNG outputs and the GitHub figure gallery
```
