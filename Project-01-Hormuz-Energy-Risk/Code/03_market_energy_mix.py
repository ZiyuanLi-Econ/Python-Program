...
save_figure(fig, "05_selected_market_total_energy_2024.png")
...
save_figure(fig, "06_selected_market_energy_amount_2024.png")
...
ax.set_ylim(0, 105)
ax.set_title(f"Energy Mix in Selected Markets, {YEAR}", fontweight="bold", pad=55)
ax.set_xlabel("")
...
ax.grid(axis="y", alpha=0.2)
ax.spines[["top", "right"]].set_visible(False)
save_figure(fig, "07_selected_market_energy_mix_2024.png")
